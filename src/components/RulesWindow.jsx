...
function RulesWindow() {
    return (
        <div className="absolute right-[-100vw] bg-[#5c5c5c43] w-full h-full flex justify-center">
            <div className="absolute top-[5%]  bg-[#ffffff] rounded-lg  w-[80%] h-[70%] flex flex-col items-center justify-center gap-10">
                ...
                />
                <button className="text-[#8A90AC] font-barlow tracking-wide font-bold text-xl hover-default border-[#B3B6C6] border-[3.5px] rounded-md px-4 py-[3px]">
                    CLOSE
                </button>
            </div>
        </div>
